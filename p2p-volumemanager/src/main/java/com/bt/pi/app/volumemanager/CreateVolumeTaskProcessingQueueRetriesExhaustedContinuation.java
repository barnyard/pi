 ...
 */
@Component
public class CreateVolumeTaskProcessingQueueRetriesExhaustedContinuation extends AbstractVolumeTaskProcessingQueueContinuation implements TaskProcessingQueueRetriesExhaustedContinuation {
    private static final Log LOG = LogFactory.getLog(CreateVolumeTaskProcessingQueueRetriesExhaustedContinuation.class);

    public CreateVolumeTaskProcessingQueueRetriesExhaustedContinuation() {
        super();
    }
    ...
    public void receiveResult(String uri, String nodeId) {
        ...
        writer.update(id, new VolumeStatusUpdatingContinuation(VolumeState.FAILED, "creation"));
    }
}
