...
public class AttachVolumeTaskProcessingQueueRetriesExhaustedContinuationTest {
    @InjectMocks
    private AttachVolumeTaskProcessingQueueRetriesExhaustedContinuation attachVolumeTaskProcessingQueueRetriesExhaustedContinuation = new AttachVolumeTaskProcessingQueueRetriesExhaustedContinuation();
    @Mock
    ...
    public void testReceiveResult() throws Exception {
        ...
        // act
        this.attachVolumeTaskProcessingQueueRetriesExhaustedContinuation.receiveResult(volumeUri, nodeId);
