...
public class DeleteVolumeTaskProcessingQueueRetriesExhaustedContinuationTest {
    @InjectMocks
    private DeleteVolumeTaskProcessingQueueRetriesExhaustedContinuation deleteVolumeTaskProcessingQueueRetriesExhaustedContinuation = new DeleteVolumeTaskProcessingQueueRetriesExhaustedContinuation();
    @Mock
    ...
    public void testReceiveResult() throws Exception {
        ...
        // act
        this.deleteVolumeTaskProcessingQueueRetriesExhaustedContinuation.receiveResult(volumeUri, nodeId);
