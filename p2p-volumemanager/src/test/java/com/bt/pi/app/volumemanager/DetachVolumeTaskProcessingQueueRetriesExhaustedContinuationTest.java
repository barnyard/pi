...
public class DetachVolumeTaskProcessingQueueRetriesExhaustedContinuationTest {
    @InjectMocks
    private DetachVolumeTaskProcessingQueueRetriesExhaustedContinuation detachVolumeTaskProcessingQueueRetriesExhaustedContinuation = new DetachVolumeTaskProcessingQueueRetriesExhaustedContinuation();
    @Mock
    ...
    public void testReceiveResult() throws Exception {
        ...
        // act
        this.detachVolumeTaskProcessingQueueRetriesExhaustedContinuation.receiveResult(volumeUri, nodeId);
