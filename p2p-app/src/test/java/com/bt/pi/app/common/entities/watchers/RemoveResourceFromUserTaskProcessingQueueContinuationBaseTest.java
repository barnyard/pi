...
public class RemoveResourceFromUserTaskProcessingQueueContinuationBaseTest {
    ...
    private boolean nullInvoked = false;
    ...
    public void testThatUrlIsRemovedFromQueue() throws Exception {
        ...
        // assert
        verify(taskProcessingQueueHelper).removeUrlFromQueue(queueId, uri);
    }
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testThatResourceNotFoundThrowsNoExceptions() throws Exception {
        // setup
        doAnswer(new Answer<Object>() {
            @Override
            public Object answer(InvocationOnMock invocation) throws Throwable {
