...
public class PisssBasicScenario extends PisssScenarioBase {
	public PisssBasicScenario(ScheduledExecutorService executor, PircData aPircData) {
	...
	protected void addCommands(final String scenarioId, final AtomicBoolean scenarioCompleted, Map<String, Object> params, Queue<ScenarioCommand> commandQueue) {
		...
		commandQueue.add(new S3ListBucketsCommand(runDetails));
		commandQueue.add(new S3PutObjectInBucketScenarioCommand(runDetails, "1M"));
