...
public class AssociateAddressOutputParser extends OutputParserBase {
private static final String ASSIGN_LINE_REGEX = "^ADDRESS\\s+(\\S+)\\s+\\S+\\s*$";
	...
	protected String parseLine(int lineNumber, String line) {
		if (lineNumber == 0) {
			Pattern p = Pattern.compile(ASSIGN_LINE_REGEX);
