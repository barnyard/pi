...
The ec2-bundle-image, ec2-upload-bundle and ec2-delete-bundle utilies
should work across Linux distributions provided the above dependencies
are met. The ec2-bundle-vol utility is only expected to work correctly
on Fedora Core, though it may work on others.
