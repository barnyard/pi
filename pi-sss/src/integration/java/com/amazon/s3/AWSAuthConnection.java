...
/**
 * An interface into the S3 system. It is initially configured with authentication and connection parameters and exposes
 * methods to access and manipulate S3 data.
 */
public class AWSAuthConnection {
     ...
     * @param headers
     *            A Map of String to List of Strings representing the http headers to pass (can be null).
     ...
     *            The maximum number of keys to return (can be null).
     * @param delimiter
     *            Keys that contain a string between the prefix and the first occurrence of the delimiter will be rolled
     *            up into a single element.
     * @param headers
     *            A Map of String to List of Strings representing the http headers to pass (can be null).
     */
     ...
     *            The name of the key to use.
     * @param headers
     *            A Map of String to List of Strings representing the http headers to pass (can be null). You may wish
     *            to set the x-amz-acl header appropriately.
     */
    public Response copy(String sourceBucket, String sourceKey, String destinationBucket, String destinationKey, Map<String, List<String>> headers) throws MalformedURLException, IOException {
        S3Object object = new S3Object(new byte[] {}, new HashMap<String, List<String>>());
        headers = headers == null ? new HashMap<String, List<String>>() : new HashMap<String, List<String>>(headers);
    ...
    /**
     * Creates a copy of an existing S3 Object. In this signature, we will replace the existing metadata. The default
     * access control policy is private; if you want to override it, please use x-amz-acl in the headers.
     * 
     * @param sourceBucket
     *            The name of the bucket where the source object lives.
     ...
     *            The name of the key to use.
     * @param metadata
     *            A Map of String to List of Strings representing the S3 metadata for the new object.
     * @param headers
     *            A Map of String to List of Strings representing the http headers to pass (can be null). You may wish
     *            to set the x-amz-acl header appropriately.
     */
    public Response copy(String sourceBucket, String sourceKey, String destinationBucket, String destinationKey, Map<String, List<String>> metadata, Map<String, List<String>> headers) throws MalformedURLException, IOException {
     ...
     * processes those whitespace characters and will throw an exception if the response is either unknown or an error.
     * 
     * @param response
     ...
     *            A Map of String to List of Strings representing the http headers to pass (can be null).
     */
    public GetResponse getBucketRequestPayment(String bucket, Map<String, List<String>> headers) throws MalformedURLException, IOException {
     ...
     * 
     * @param loggingXMLDoc
     *            The xml representation of the requestPayment configuration as a String
     * @param bucket
     *            The name of the bucket
     * @param headers
     *            A Map of String to List of Strings representing the http headers to pass (can be null).
     */
    public Response putBucketRequestPayment(String bucket, String requestPaymentXMLDoc, Map<String, List<String>> headers) throws MalformedURLException, IOException {
        Map<String, String> pathArgs = new HashMap<String, String>();
        pathArgs.put("requestPayment", null);
    ...
    /**
     * Make a new HttpURLConnection without passing an S3Object parameter. Use this method for key operations that do
     * require arguments
     * 
     * @param method
        ...
        if (headers != null) {
            for (Entry<String, List<String>> entry : headers.entrySet()) {
                ...
                for (String headerValue : entry.getValue()) {
                    connection.addRequestProperty(prefix + key, headerValue);
                }
            }
        }
    }
