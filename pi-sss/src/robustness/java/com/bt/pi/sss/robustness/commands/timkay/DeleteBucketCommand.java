...
public class DeleteBucketCommand extends TimKayCommandBase {
	...
	protected void execute(Map<String, Object> params) throws Throwable {
		// setup
		String command = String.format("%s -vvv delete %s", getTimKayBaseCommand(params), getBucketName(params));
		...
		// assert
		assertResponse(commandExecutor.getErrorLines(), "204 No Content", "delete bucket failed: ");
	}
